    ...
    <div id="app">
        <section class="section">
            <div class="d-flex align-items-stretch flex-wrap">
                ...
                <div class="col-lg-8 col-12 order-lg-12 min-vh-200 background-walk-y position-relative overlay-gradient-bottom order-1" data-background="{{ asset('img/logo_pt_pal.jpg') }}">
